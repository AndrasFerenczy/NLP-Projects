...
These were built as graduate coursework for the [Natural Language Processing](https://lm-class.org/assignments) course at Cornell University and are intended to demonstrate practical ML engineering for Natural Langauge Processing: implementing models from scratch, comparing baselines, and measuring systems with task-appropriate metrics.
